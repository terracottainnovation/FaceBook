package com.tejas.facebook.util;
...
public class ProperyReader {
	...
	private  String PROPERTY_FILE_NAME = "/property/FacebookConfiguration.properties";
	/**
	...
	public ProperyReader() {
		...
		try{
			...
			logger.error("StoreLocatorConfiguration.properties file not found");
			e.printStackTrace();
		} catch (IOException e) {
